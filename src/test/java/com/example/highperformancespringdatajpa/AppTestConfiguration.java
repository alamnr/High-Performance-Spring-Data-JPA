    ...
    */
    ...
    ApplicationRunner applicationRunner(AccountRepository accountRepository, BankTransferRepository bankTransferRepository){
        return args -> {
            ...
            bankTransferRepository.save(new BankTransfer("bank-transfer-id", "reference-2", sender, receiver, Amount.of(100,"CHF")));
    ...
    public static void main(String... args){
        SpringApplication.from(HighPerformanceSpringDataJpaApplication::main)
